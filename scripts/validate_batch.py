"""
Runs our data contract (orders_contract) against a batch of data
and prints out which rules passed/failed.

Usage: python3 scripts/validate_batch.py <path_to_csv>
"""
...
# reuse the datasource/asset we already registered in setup_gx.py
...
# go through each rule and show a clear pass/fail summary
